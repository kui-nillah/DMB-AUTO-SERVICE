...
$k=$_GET['uid'];
$cc="SELECT * FROM enquiry WHERE id='$k'";
...
$tsap=$_POST['tsap'];
$mail=$_POST['mail'];
$set="UPDATE enquiry SET tel='$tel',tsap='$tsap',mail='$mail' WHERE id='$k'";
...
<html>
    ...
    <div class="log">
   <center><form method="POST" action="update.php" autocomplete="off">
   <br>
   <br>
    ...
    <input type="text" name="tsap" maxlenght="25" placeholder="" value="<?php echo $tsap;?>" required>
    <br>
    <br>
    <label>Email address</label><br>
    <input type="email" name="mail" maxlenght="250" placeholder="Email address" value="<?php echo $mail;?>" required>
    <br>
    <br>
